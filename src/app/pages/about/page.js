    ...
    return (
        <>
            ...
            <article className="flex flex-col items-center justify-center mt-[20px] gap-7">
                ...
                <section className="flex-col gap-7 md:flex-row flex">
                    ...
                    <section className="flex flex-col items-center justify-center">
                        ...
                        <p className="w-[20rem] md:w-[25rem] lg:w-[50rem] font-main md:text-4xl">Hello! My name is Kenny and I&apos;m currently a photographer for fun whose currently trying to become a Web Developer! 
                ...
                <section className="flex flex-col md:flex-row items-center justify-center gap-7 mt-4">
